...
public class NonUrgentEventActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nonWhat = getIntent().getStringExtra("nonWhat");
    ...
    private void initView() {
        ...
        imageButton19.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                test(nonWhat+"##"+imageButton139.getText().toString()+" "+imageButton117.getText().toString()+":"
                        +imageButton118.getText().toString()+"##"+editTextTextPersonName5.getText().toString()+"##2",mList.get(position).getToken());
//                Message m = new Message(nonWhat+"##"+imageButton139.getText().toString()+" "+imageButton117.getText().toString()+":"
//                        +imageButton118.getText().toString()+"##"+editTextTextPersonName5.getText().toString()+"##2",mList.get(position).getEmail(),1);
//                boolean re = m.save();
//                if (re){
//                    Toast.makeText(NonUrgentEventActivity.this,"send success",Toast.LENGTH_SHORT).show();
//                }else {
//                    Toast.makeText(NonUrgentEventActivity.this,"send error",Toast.LENGTH_SHORT).show();
//                }
//                test(editTextTextPersonName5.getText().toString(),mList.get(position).getToken());
        ...
        imageButton139.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(NonUrgentEventActivity.this,
