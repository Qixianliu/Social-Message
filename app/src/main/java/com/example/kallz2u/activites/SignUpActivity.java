...
//        user.put(Constants.KEY_EMAIL,binding.editEmailAddress.getText().toString());
//        user.put(Constants.KEY_PASSWORD,binding.editTextTextPassword.getText().toString());
//        user.put(Constants.KEY_IMAGE,encodedImage);
//        database.collection(Constants.KEY_COLLECTION_USER)
//                .add(user)
//                .addOnSuccessListener(documentReference -> {
//                    Log.e("========",documentReference.getId()+"---"+documentReference.getPath());
...
//                return false;
//            } else if(binding.editEmailAddress.getText().toString().trim().isEmpty()){
