...
public final class ActivityThirdBinding implements ViewBinding {
  ...
  private ActivityThirdBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull ImageView imageView4, @NonNull TextView textView4, @NonNull TextView textView5,
  ...
  public static ActivityThirdBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityThirdBinding((ConstraintLayout) rootView, imageButton7, imageButton8,
          imageView4, textView4, textView5, textView7, textView8);
    }
